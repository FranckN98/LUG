# Blog post 003 — Level Up in Germany 2025

URL : https://www.levelupingermany.com/fr/blog-impact/blog-post-003
Auteur : Équipe Level Up in Germany · Catégorie : IMPACT

> ⚠️ Cet article contient une image inline à conserver à l'identique :
> `![image](https://ilehbjm6jtrg2e7b.public.blob.vercel-storage.com/media/74b8c363-91ae-4e3d-a7fd-5596b4fab27d.jpg)`
> Elle doit être placée juste avant le paragraphe "Si tu es en Allemagne, que tu sois étudiant…"
...
### Title
Level Up in Germany 2025: a day to learn, recognize ourselves and move forward

### Excerpt
The first edition of Level Up in Germany was much more than a conference: a moment of meeting where the African diaspora in Germany spoke openly about what they really live.

### Meta title
Level Up in Germany 2025 — what we lived during the first edition

### Meta description
Behind the scenes of the first Level Up in Germany conference: speakers, real stories, money, mental health, careers, integration and the power of community.
...
### Excerpt
Die erste Ausgabe von Level Up in Germany war weit mehr als eine Konferenz: ein Treffpunkt, an dem die afrikanische Diaspora in Deutschland offen darüber sprach, was sie wirklich erlebt.

### Meta title
Level Up in Germany 2025 — was wir bei der ersten Ausgabe erlebt haben

### Meta description
Hinter den Kulissen der ersten Level Up in Germany Konferenz: Speaker, echte Geschichten, Geld, mentale Gesundheit, Karriere, Integration und die Kraft der Community.
...
Wenn du in Deutschland bist — ob als Student, Auszubildender, junger Berufstätiger, Unternehmer oder einfach auf der Suche nach Richtung — ist Level Up in Germany ein Termin, den man nicht verpassen sollte.
