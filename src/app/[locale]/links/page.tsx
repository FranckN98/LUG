      ...
      <section className="relative z-10 mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <header className="relative mb-12 flex flex-col items-center text-center">
          ...
          <div className="relative mb-6">
            ...
            />
            <div className="relative grid h-[6.3rem] w-[6.3rem] place-items-center overflow-hidden rounded-full border border-white/20 bg-white shadow-[0_10px_40px_-10px_rgba(0,0,0,0.7)] sm:h-[7.35rem] sm:w-[7.35rem]">
              <img
                src="/logo.png"
