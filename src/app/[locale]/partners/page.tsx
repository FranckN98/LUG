...
const content: Record<Locale, {
  ...
  de: {
    ...
    perks: [
      { title: 'Sichtbarkeit', body: 'Präsenz auf Events, auf der Website und in den sozialen Medien vor einer aktiven Community.' },
      { title: 'Netzwerk', body: 'Direkter Zugang zu Fachkräften, Gründer:innen und Talenten aus der Diaspora.' },
      { title: 'Wirkung', body: 'Ihr Engagement hilft konkret bei Ankunft, Aufstieg und Zusammenhalt.' },
    ],
  },
  en: {
    eyebrow: 'Our Network',
    ...
    perks: [
      { title: 'Visibility', body: 'Presence at events, on our website and on social media in front of an active community.' },
      { title: 'Network', body: 'Direct access to professionals, founders and talents from the diaspora.' },
      { title: 'Impact', body: 'Your support directly helps with arrival, growth and a stronger community.' },
    ],
  },
  fr: {
    ...
    perks: [
      { title: 'Visibilité', body: 'Présence lors des événements, sur le site et sur les réseaux, devant une communauté active.' },
      { title: 'Réseau', body: 'Accès direct à des pros, entrepreneurs et talents de la diaspora.' },
      { title: 'Impact', body: 'Votre soutien aide concrètement à mieux s’installer, à progresser et à faire communauté.' },
    ],
  },
};
