...
const SITE_ROUTES = [
  ...
  { label: 'Mentions legales', value: '/imprint' },
  { label: 'Confidentialite', value: '/privacy' },
];
...
function buttonVariantPreviewClass(variant: string): string {
  switch (variant) {
    ...
    case 'green':
      return 'bg-[#2f5d3a] text-white border border-[#2f5d3a]';
    case 'white':
